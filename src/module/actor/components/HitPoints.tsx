		...
		<>
			...
			<div className="flex justify-start items-center gap-1 text-lg">
				<FormInput className="w-16">
					<FormInput.AutoNumberField field="data.health.currentHp" className="text-center" />
			...
			<label>
				...
				<div className="inline-block w-16 pl-2">
					<FormInput.AutoNumberField field="data.health.temporaryHp" className="text-center" />
				</div>
			</label>
		</>
	);
